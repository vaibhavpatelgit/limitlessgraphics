    ...
    async function loadPortfolioList(serviceInfoId) {
        ...
        try {
            ...
            const normalized = arr.map((r)=>({
                    ...
                    title: r.title ?? "",
                    imageUrl: r.image ? String(r.image).startsWith("http") ? r.image : `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PORTFOLIO_IMAGE_BASE"]}${r.image}` : null,
                    _raw: r
                }));
...
//# sourceMappingURL=src_206e5ffa._.js.map