...
function PortfolioClient({ items = [], filters = [] }) {
    ...
    const safeFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PortfolioClient.useMemo[safeFilters]": ()=>{
            const derived = Array.isArray(filters) && filters.length ? filters : [
                "All",
                ...Array.from(new Set(allItems.map({
                    "PortfolioClient.useMemo[safeFilters]": (x)=>x.category
                }["PortfolioClient.useMemo[safeFilters]"]).filter(Boolean)))
            ];
            const rest = derived.filter({
                "PortfolioClient.useMemo[safeFilters].rest": (f)=>norm(f) !== "all"
            }["PortfolioClient.useMemo[safeFilters].rest"]);
            return [
                "All",
                ...rest
            ];
    ...
    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PortfolioClient.useMemo[data]": ()=>{
            ...
            return allItems.filter({
                "PortfolioClient.useMemo[data]": (i)=>norm(i.category) === f
            }["PortfolioClient.useMemo[data]"]);
        }
    }["PortfolioClient.useMemo[data]"], [
        allItems,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortfolioClient.useEffect": ()=>setLightboxIdx(-1)
    }["PortfolioClient.useEffect"], [
        filter
    ]);
    ...
    const next = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PortfolioClient.useCallback[next]": ()=>{
            ...
            setLightboxIdx({
                "PortfolioClient.useCallback[next]": (i)=>(i < 0 ? 0 : i + 1) % len
            }["PortfolioClient.useCallback[next]"]);
        }
    }["PortfolioClient.useCallback[next]"], [
        data.length
    ...
    const prev = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PortfolioClient.useCallback[prev]": ()=>{
            const len = data.length || 1;
            setLightboxIdx({
                "PortfolioClient.useCallback[prev]": (i)=>(i < 0 ? 0 : i - 1 + len) % len
            }["PortfolioClient.useCallback[prev]"]);
        }
    }["PortfolioClient.useCallback[prev]"], [
        data.length
...
_s(PortfolioClient, "mxU6QV5l81g2hrjWdxfDeVqtqWQ=");
_c = PortfolioClient;
var _c;
...
//# sourceMappingURL=src_app_portfolio_PortfolioClient_jsx_f5adee8e._.js.map