...
const DOTNET_API_BASE = "https://localhost:44328"; // change if needed
const API = {
...
"[project]/src/app/admin/services/service-type/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "default": ()=>ServiceTypePage,
    "metadata": ()=>metadata
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
...
function ServiceTypePage() {
    ...
    async function load() {
        ...
        try {
            ...
            // normalize field names just in case (titile vs title)
            const normalized = (Array.isArray(data) ? data : []).map((r)=>({
                    id: r.id ?? r.ServiceId ?? r.serviceId ?? 0,
                    ServiceId: r.ServiceId ?? r.id ?? r.serviceId ?? 0,
                    title: r.title ?? r.titile ?? "",
                    ordernumber: r.ordernumber ?? r.orderNumber ?? r.sort_order ?? 0,
            ...
            console.error(e);
            alert("Could not load services. Check API URL/CORS.");
        } finally{
            setLoading(false);
        }
    }
    ...
    function openEdit(r) {
        setForm({
            ...
            ordernumber: r.ordernumber ?? r.orderNumber ?? 0,
            title: r.title ?? r.titile ?? "",
            file: null
        });
        setOpen(true);
    }
    // submit Add/Edit to .NET API
    async function submit(e) {
        e.preventDefault();
        try {
            // Build multipart/form-data if there is a file, else JSON
            const hasFile = !!form.file;
            let res;
            if (hasFile) {
                const fd = new FormData();
                fd.append("ServiceId", String(form.ServiceId || 0));
                fd.append("ordernumber", String(form.ordernumber || 0));
                // API sample shows "titile" — include both to be safe
                fd.append("titile", form.title);
                fd.append("title", form.title);
                fd.append("image", form.file); // field name "image" (change if API expects different)
                res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API"].UPSERT, {
                    method: "POST",
                    body: fd
                });
            } else {
    ...
    async function onDelete(id) {
        ...
        try {
            ...
            if (!res.ok) {
                // Some .NET APIs use GET for delete. If 405, try GET as fallback.
                if (res.status === 405) {
            ...
            console.error(e);
            alert(e.message || "Delete failed (check DELETE endpoint URL)");
        }
    }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/src/app/admin/services/service-type/page.js",
                        lineNumber: 155,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>onDelete(r.id || r.ServiceId),
...
//# sourceMappingURL=_a2b25e12._.js.map