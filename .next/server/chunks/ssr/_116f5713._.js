...
const API = {
    ...
    DELETE: (id)=>`${DOTNET_API_BASE}/api/Service/DeleteService?id=${id}`,
    UPLOAD: `${DOTNET_API_BASE}/api/Service/uploaddocuments`
};
const IMAGE_BASE = `${DOTNET_API_BASE}/Files/Services/`;
}),
"[project]/src/app/admin/services/service-type/ServiceTypeClient.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "default": ()=>ServiceTypeClient
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
...
function ServiceTypeClient() {
    const [rows, setRows] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]); // all items from API
    ...
    async function load() {
        setLoading(true);
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API"].LIST, {
                cache: "no-store"
            });
            if (!res.ok) throw new Error("Failed to load list");
            const data = await res.json();
            const arr = Array.isArray(data?.GetAllService) ? data.GetAllService : [];
            const normalized = arr.map((r)=>{
                const filename = r.coverimage ?? null; // API returns file name or null
                return {
                    id: r.ServicesID,
                    ServiceId: r.ServicesID,
                    title: r.titile ?? "",
                    ordernumber: r.ordernumber ?? 0,
                    imageUrl: filename ? filename.startsWith("http") ? filename : `${IMAGE_BASE}${filename}` : null,
                    _raw: r
                };
            });
            setRows(normalized);
    ...
    async function uploadCover(servicesId, file) {
        ...
        // Backend expects form field name "ServicesID" (case sensitive)
        fd.append("ServicesID", String(servicesId));
        // Any file key is accepted by your code (it iterates httpRequest.Files), use "file"
        fd.append("file", file);
        const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API"].UPLOAD, {
            method: "POST",
            body: fd
        });
        if (!res.ok) {
        ...
        // Response shape per your code: { UploadDocuments: { error, message, Data } } (depending on Utility wrapper)
    ...
    async function submit(e) {
        e.preventDefault();
        try {
            // 1) JSON upsert (add or edit). Your API expects titile + ordernumber + ServiceId
            const payload = {
                ServiceId: Number(form.ServiceId || 0),
                ordernumber: Number(form.ordernumber || 0),
                titile: form.title
            };
            const upRes = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API"].UPSERT, {
                method: "POST",
                headers: {
            ...
            // Example response you showed:
            // { "ServiceAdd": { "error": false, "message": null, "Data": { "ServicesID": 7, ... } } }
            const upJson = await upRes.json().catch(()=>({}));
            const newId = upJson?.ServiceAdd?.Data?.ServicesID ?? upJson?.ServicesID ?? form.ServiceId; // fallback to existing id on edit
            // 2) If a file is selected, upload file to uploaddocuments with ServicesID
            if (form.file && newId) {
    ...
    async function onDelete(id) {
        ...
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API"].DELETE(id), {
                method: "DELETE"
            });
            if (!res.ok) {
                // Some .NET setups use GET for delete; fallback if 405/404.
                if (res.status === 405 || res.status === 404) {
                    const r2 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API"].DELETE(id)); // GET fallback
            ...
            console.error(e);
            alert(e.message || "Delete failed (check endpoint)");
        }
    }
                            ...
                            children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                columnNumber: 15
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-4 py-3",
                                            children: r.ordernumber ?? r.orderNumber ?? "-"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/services/service-type/ServiceTypeClient.jsx",
                                            lineNumber: 225,
                                            columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-4 py-3",
                                            children: r.imageUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                src: r.imageUrl,
                                                alt: "",
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                form.file && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "mt-1 text-xs text-neutral-500",
                                    children: "(Note: current API doesn’t accept file upload on this endpoint. We’ll add an image upload route next.)"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/services/service-type/ServiceTypeClient.jsx",
                                    lineNumber: 338,
                                    columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    className: "rounded-xl px-4 py-2 bg-emerald-600 hover:bg-emerald-500 font-medium",
                                    children: "Save"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/services/service-type/ServiceTypeClient.jsx",
                                    lineNumber: 353,
...
//# sourceMappingURL=_116f5713._.js.map