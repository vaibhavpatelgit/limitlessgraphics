...
const API = {
    ...
    DELETE: (id)=>"".concat(DOTNET_API_BASE, "/api/Service/DeleteService?id=").concat(id)
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/admin/services/service-type/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ServiceTypePage() {
    _s();
    const [rows, setRows] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // all items from API
    ...
    async function load() {
        setLoading(true);
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].LIST, {
                cache: "no-store"
            });
            ...
            const normalized = (Array.isArray(data) ? data : []).map((r)=>{
                var _r_id, _ref, _ref1, _r_ServiceId, _ref2, _ref3, _r_title, _ref4, _r_ordernumber, _ref5, _ref6, _r_imageUrl, _ref7;
                return {
                    id: (_ref1 = (_ref = (_r_id = r.id) !== null && _r_id !== void 0 ? _r_id : r.ServiceId) !== null && _ref !== void 0 ? _ref : r.serviceId) !== null && _ref1 !== void 0 ? _ref1 : 0,
                    ServiceId: (_ref3 = (_ref2 = (_r_ServiceId = r.ServiceId) !== null && _r_ServiceId !== void 0 ? _r_ServiceId : r.id) !== null && _ref2 !== void 0 ? _ref2 : r.serviceId) !== null && _ref3 !== void 0 ? _ref3 : 0,
                    title: (_ref4 = (_r_title = r.title) !== null && _r_title !== void 0 ? _r_title : r.titile) !== null && _ref4 !== void 0 ? _ref4 : "",
                    ordernumber: (_ref6 = (_ref5 = (_r_ordernumber = r.ordernumber) !== null && _r_ordernumber !== void 0 ? _r_ordernumber : r.orderNumber) !== null && _ref5 !== void 0 ? _ref5 : r.sort_order) !== null && _ref6 !== void 0 ? _ref6 : 0,
                    imageUrl: (_ref7 = (_r_imageUrl = r.imageUrl) !== null && _r_imageUrl !== void 0 ? _r_imageUrl : r.image) !== null && _ref7 !== void 0 ? _ref7 : null,
                    ...r
                };
            });
            setRows(normalized);
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ServiceTypePage.useMemo[filtered]": ()=>{
            if (!q) return rows;
            const qq = q.toLowerCase();
            return rows.filter({
                "ServiceTypePage.useMemo[filtered]": (r)=>(r.title || "").toLowerCase().includes(qq)
            }["ServiceTypePage.useMemo[filtered]"]);
        }
    }["ServiceTypePage.useMemo[filtered]"], [
        rows,
    ...
    // open Edit modal
    function openEdit(r) {
        var _r_ordernumber, _ref, _r_title, _ref1;
        setForm({
            ServiceId: r.ServiceId || r.id,
            ordernumber: (_ref = (_r_ordernumber = r.ordernumber) !== null && _r_ordernumber !== void 0 ? _r_ordernumber : r.orderNumber) !== null && _ref !== void 0 ? _ref : 0,
            title: (_ref1 = (_r_title = r.title) !== null && _r_title !== void 0 ? _r_title : r.titile) !== null && _ref1 !== void 0 ? _ref1 : "",
            file: null
        });
        setOpen(true);
    }
    ...
    async function submit(e) {
        ...
        try {
            ...
            if (hasFile) {
                ...
                res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].UPSERT, {
                    method: "POST",
                    body: fd
                });
            } else {
    ...
    async function onDelete(id) {
        ...
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].DELETE(id), {
                method: "DELETE"
            });
            if (!res.ok) {
                // Some .NET APIs use GET for delete. If 405, try GET as fallback.
                if (res.status === 405) {
                    const r2 = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].DELETE(id)); // GET fallback
                            ...
                            children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-4 py-3",
                                            children: (_ref = (_r_ordernumber = r.ordernumber) !== null && _r_ordernumber !== void 0 ? _r_ordernumber : r.orderNumber) !== null && _ref !== void 0 ? _ref : "-"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/services/service-type/page.js",
                                            lineNumber: 208,
                                            columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "px-4 py-3",
                                            children: (_ref1 = (_r_title = r.title) !== null && _r_title !== void 0 ? _r_title : r.titile) !== null && _ref1 !== void 0 ? _ref1 : "-"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/services/service-type/page.js",
                                            lineNumber: 211,
                                            columnNumber: 19
...
_s(ServiceTypePage, "vV4wUqAbSaZyovU/2GG4oHBwDm0=");
_c = ServiceTypePage;
var _c;
__turbopack_context__.k.register(_c, "ServiceTypePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_2fb2c1cd._.js.map