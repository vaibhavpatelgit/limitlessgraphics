...
"[project]/src/app/portfolio/PortfolioClient.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PortfolioClient() {
    ...
    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PortfolioClient.useMemo[data]": ()=>filter === "All" ? ITEMS : ITEMS.filter({
                "PortfolioClient.useMemo[data]": (i)=>i.category === filter
            }["PortfolioClient.useMemo[data]"])
    }["PortfolioClient.useMemo[data]"], [
        filter
    ]);
    const open = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PortfolioClient.useCallback[open]": (idx)=>setLightboxIdx(idx)
    }["PortfolioClient.useCallback[open]"], []);
    const close = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PortfolioClient.useCallback[close]": ()=>setLightboxIdx(-1)
    }["PortfolioClient.useCallback[close]"], []);
    const next = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PortfolioClient.useCallback[next]": ()=>setLightboxIdx({
                "PortfolioClient.useCallback[next]": (i)=>(i + 1) % data.length
            }["PortfolioClient.useCallback[next]"])
    }["PortfolioClient.useCallback[next]"], [
        data.length
    ]);
    const prev = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PortfolioClient.useCallback[prev]": ()=>setLightboxIdx({
                "PortfolioClient.useCallback[prev]": (i)=>(i - 1 + data.length) % data.length
            }["PortfolioClient.useCallback[prev]"])
    }["PortfolioClient.useCallback[prev]"], [
        data.length
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortfolioClient.useEffect": ()=>{
            ...
            const onKey = {
                "PortfolioClient.useEffect.onKey": (e)=>{
                    if (e.key === "Escape") close();
                    if (e.key === "ArrowRight") next();
                    if (e.key === "ArrowLeft") prev();
                }
            }["PortfolioClient.useEffect.onKey"];
            window.addEventListener("keydown", onKey);
            return ({
                "PortfolioClient.useEffect": ()=>window.removeEventListener("keydown", onKey)
            })["PortfolioClient.useEffect"];
        }
    }["PortfolioClient.useEffect"], [
        lightboxIdx,
...
_s(PortfolioClient, "3POHdS696qTbq/UgG2GRY8dCrUQ=");
_c = PortfolioClient;
/* ------------------ LIGHTBOX ------------------ */ function LightboxBody(param) {
...
//# sourceMappingURL=src_app_portfolio_PortfolioClient_jsx_ac2bd6c7._.js.map