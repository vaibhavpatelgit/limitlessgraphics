...
function ServiceTypeClient() {
    ...
    async function load() {
        ...
        try {
            ...
            const normalized = arr.map((r)=>{
                var _r_coverimage;
                const filename = (_r_coverimage = r.coverimage) !== null && _r_coverimage !== void 0 ? _r_coverimage : null;
                const imageUrl = filename ? String(filename).startsWith("http") ? filename : "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IMAGE_BASE"]).concat(filename) : null;
                var _r_titile, _r_ordernumber, _r_description, _ref, _ref1;
                return {
                    id: r.ServicesID,
                    ServiceId: r.ServicesID,
                    title: (_r_titile = r.titile) !== null && _r_titile !== void 0 ? _r_titile : "",
                    ordernumber: (_r_ordernumber = r.ordernumber) !== null && _r_ordernumber !== void 0 ? _r_ordernumber : 0,
                    description: (_ref1 = (_ref = (_r_description = r.description) !== null && _r_description !== void 0 ? _r_description : r.Description) !== null && _ref !== void 0 ? _ref : r.descriptions) !== null && _ref1 !== void 0 ? _ref1 : "",
                    imageUrl,
                    _raw: r
                };
            });
    ...
    // ---------- Open modal: Edit ----------
    function openEdit(r) {
        var _r_ordernumber, _r_title, _r_description;
        setForm({
            ServiceId: r.ServiceId || r.id,
            ordernumber: (_r_ordernumber = r.ordernumber) !== null && _r_ordernumber !== void 0 ? _r_ordernumber : 0,
            title: (_r_title = r.title) !== null && _r_title !== void 0 ? _r_title : "",
            description: (_r_description = r.description) !== null && _r_description !== void 0 ? _r_description : "",
            file: null,
    ...
    async function submit(e) {
        e.preventDefault();
        try {
            var _upJson_ServiceAdd_Data, _upJson_ServiceAdd, _upJson_Data;
            setSubmitting(true);
            // 1) Upsert JSON first
            const payload = {
            ...
            var _upJson_ServiceAdd_Data_ServicesID, _ref, _ref1;
            const newId = (_ref1 = (_ref = (_upJson_ServiceAdd_Data_ServicesID = upJson === null || upJson === void 0 ? void 0 : (_upJson_ServiceAdd = upJson.ServiceAdd) === null || _upJson_ServiceAdd === void 0 ? void 0 : (_upJson_ServiceAdd_Data = _upJson_ServiceAdd.Data) === null || _upJson_ServiceAdd_Data === void 0 ? void 0 : _upJson_ServiceAdd_Data.ServicesID) !== null && _upJson_ServiceAdd_Data_ServicesID !== void 0 ? _upJson_ServiceAdd_Data_ServicesID : upJson === null || upJson === void 0 ? void 0 : (_upJson_Data = upJson.Data) === null || _upJson_Data === void 0 ? void 0 : _upJson_Data.ServicesID) !== null && _ref !== void 0 ? _ref : upJson === null || upJson === void 0 ? void 0 : upJson.ServicesID) !== null && _ref1 !== void 0 ? _ref1 : payload.ServicesID;
...
//# sourceMappingURL=src_2b238f7e._.js.map