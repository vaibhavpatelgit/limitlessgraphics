...
function ServiceTypeClient() {
    ...
    async function load() {
        ...
        try {
            ...
            const arr = Array.isArray(data === null || data === void 0 ? void 0 : data.GetAllService) ? data.GetAllService : [];
            const normalized = arr.map((r)=>{
                var _r_coverimage;
                const filename = (_r_coverimage = r.coverimage) !== null && _r_coverimage !== void 0 ? _r_coverimage : null; // API returns file name or null
                var _r_titile, _r_ordernumber;
                return {
                    id: r.ServicesID,
                    ...
                    imageUrl: filename ? filename.startsWith("http") ? filename : "".concat(IMAGE_BASE).concat(filename) : null,
                    _raw: r
                };
            });
            setRows(normalized);
    ...
    async function uploadCover(servicesId, file) {
        ...
        fd.append("file", file);
        const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].UPLOAD, {
            method: "POST",
            body: fd
        });
        if (!res.ok) {
    ...
    async function submit(e) {
        e.preventDefault();
        try {
            var _upJson_ServiceAdd_Data, _upJson_ServiceAdd;
            ...
            const upRes = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"].UPSERT, {
                method: "POST",
                headers: {
            ...
            var _upJson_ServiceAdd_Data_ServicesID, _ref;
            const newId = (_ref = (_upJson_ServiceAdd_Data_ServicesID = upJson === null || upJson === void 0 ? void 0 : (_upJson_ServiceAdd = upJson.ServiceAdd) === null || _upJson_ServiceAdd === void 0 ? void 0 : (_upJson_ServiceAdd_Data = _upJson_ServiceAdd.Data) === null || _upJson_ServiceAdd_Data === void 0 ? void 0 : _upJson_ServiceAdd_Data.ServicesID) !== null && _upJson_ServiceAdd_Data_ServicesID !== void 0 ? _upJson_ServiceAdd_Data_ServicesID : upJson === null || upJson === void 0 ? void 0 : upJson.ServicesID) !== null && _ref !== void 0 ? _ref : form.ServiceId; // fallback to existing id on edit
...
_s(ServiceTypeClient, "vV4wUqAbSaZyovU/2GG4oHBwDm0=");
...
//# sourceMappingURL=_cc2f5539._.js.map